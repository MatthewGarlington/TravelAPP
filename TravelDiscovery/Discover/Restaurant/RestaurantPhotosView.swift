...
struct RestaurantPhotosView: View {
    ...
    init() {
        ...
        //this changes every UISegmeneted Control in your application
        ...
        GeometryReader { proxy in
            ScrollView {
                ...
                Spacer()
                    ...
                    .fullScreenCover(isPresented: $shouldShowFullScreenModel, content: {
                        ZStack(alignment: .topLeading) {
                            Color.black.ignoresSafeArea()
                            
                            RestaurantCarousalView(imageURLStrings: photoURLStrings, selectedIndex: selectedPhotoIndex)
                    ...
                    //This fixes a bug showing the first item in the Full screen image by checking the State Var 
                ...
                LazyVGrid(columns: [
                    ...
                    ForEach(photoURLStrings, id: \.self) { urlString in
                        VStack(alignment: .leading, spacing: 8){
                            ...
                            Text("Desciption for your post goes here and make sure to use a bunch of lines of text to be able know if it runs smooth. \n\nGreat Job Everyone")
                                .font(.system(size: 14))
                                .padding(.horizontal, 8)
